...
const inputClass = 'h-12 rounded-2xl border border-black/[0.06] bg-[var(--slot4-surface-bg)]/85 px-4 text-base font-bold text-current outline-none transition placeholder:text-current/35 focus:border-current focus:bg-[var(--slot4-surface-bg)]'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-2xl bg-[var(--slot4-page-text)] px-6 text-sm font-extrabold uppercase tracking-[0.18em] text-[var(--slot4-page-bg)] shadow-sm transition hover:-translate-y-0.5 disabled:opacity-60'
