  ...
  return (
    <EditableSiteShell>
      <main className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <section className="rounded-[2rem] border border-black/[0.06] bg-[var(--slot4-surface-bg)] p-6 shadow-sm sm:p-8">
        ...
        {visibleComments.length ? (
          <section className="mt-8 grid gap-4">
            {visibleComments.map((item) => (
              <article key={`${item.articleSlug}-${item.id}`} className="rounded-2xl border border-black/[0.06] bg-[var(--slot4-surface-bg)] p-5 shadow-sm">
          ...
          <section className="mt-8 rounded-2xl border border-dashed border-black/[0.06] bg-[var(--slot4-surface-bg)]/70 p-8 text-center">
        ...
        {filtered.length > COMMENTS_PER_PAGE ? (
          <div className="mt-8 flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-black/[0.06] bg-[var(--slot4-surface-bg)] p-4 text-sm text-[var(--slot4-muted-text)]">
