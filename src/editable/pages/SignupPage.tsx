  ...
  return (
    <EditableSiteShell>
      <main className="bg-[var(--slot4-page-text)] text-[var(--slot4-page-bg)]">
        <section className="mx-auto grid min-h-[calc(100vh-12rem)] max-w-7xl items-center gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[0.9fr_1fr] lg:px-8">
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.08] p-6 shadow-[0_24px_70px_rgba(0,0,0,0.22)] backdrop-blur sm:p-8">
            ...
            <p className="mt-5 text-sm text-white/65">Already have an account? <Link href="/login" className="font-extrabold text-[var(--slot4-dark-text)] underline-offset-4 hover:underline">{pagesContent.auth.signup.loginCta}</Link></p>
          </div>
          <div>
